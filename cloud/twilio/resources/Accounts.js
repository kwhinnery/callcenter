...
var _ = require('underscore'),
    generate = require('cloud/twilio/resources/generate'),
...
module.exports = function (client) {
    ...
    function mixinResources(obj, sid) {
        ...
        var subresources = {
            availablePhoneNumbers:require('cloud/twilio/resources/AvailablePhoneNumbers')(client, sid),
            outgoingCallerIds:ListInstanceResource(client, sid, 'OutgoingCallerIds',
                ['GET', 'POST', 'PUT', 'DELETE', { update:'PUT' }],
                ['GET', 'POST', { create:'POST' }]
            ),
            incomingPhoneNumbers:require('cloud/twilio/resources/IncomingPhoneNumbers')(client, sid),
            sms:{
            ...
            calls:require('cloud/twilio/resources/Calls')(client, sid),
            conferences:require('cloud/twilio/resources/Conferences')(client, sid),
            queues:require('cloud/twilio/resources/Queues')(client, sid),
            recordings:require('cloud/twilio/resources/Recordings')(client, sid),
            ...
            usage:{
                records:require('cloud/twilio/resources/UsageRecords')(client, sid),
